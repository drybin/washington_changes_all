...
func mapToDomainModel(m washington_database.Day) *model.Day {
	return &model.Day{
		...
		OveralAmountUsdt: m.OveralAmountUsdt,
		OveralCoinCount:  m.OveralCoinCount,
		TierName:         m.Tiername,
		CointToBuy:       m.CoinToBuy,
	}
}
...
func mapToSaveDayInfoParams(day model.Day) washington_database.SaveDayInfoParams {
	return washington_database.SaveDayInfoParams{
		...
		OveralAmountUsdt: day.OveralAmountUsdt,
		OveralCoinCount:  day.OveralCoinCount,
		Tiername:         day.TierName,
		CoinToBuy:        day.CointToBuy,
	}
}
